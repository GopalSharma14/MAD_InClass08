...
public class InboxListViewAdapter extends RecyclerView.Adapter<InboxListViewAdapter.ViewHolder> {
    List<InboxData> mList;
    private final OnItemClickListener listener;

    public InboxListViewAdapter(List<InboxData> mList, OnItemClickListener listener) {
        this.mList = mList;
