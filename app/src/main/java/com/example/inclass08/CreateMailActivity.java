...
public class CreateMailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dd_userList = findViewById(R.id.d_userList);
        et_subject = findViewById(R.id.et_subjectofMail);
        et_message = findViewById(R.id.et_messageMail);
        btn_cancel = findViewById(R.id.btn_cancelofCreate);
        btn_send = findViewById(R.id.btn_sendofCreate);
